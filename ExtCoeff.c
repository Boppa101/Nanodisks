...
MKL_Complex16 GetCond(double EF, double gamma, double omega, double T, int op) {
    ...
    int arg6        = 1;            // Nw
    double arg7     = 0.1*q_dim;   // q_S              1/nm; the value is therefore in dim.less units: q/kF         0;//
    double arg8     = 0.1*q_dim;   // q_E              1/nm; the value is therefore in dim.less units: q/kF         0;//
    int arg9        = 1;            // Nq
    double arg10    = T;            // T                K
    int arg11       = op;           // op
